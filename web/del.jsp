...
<html>
    ...
    <tr><th colspan="7"><center>请选择您所要删除的教室，点击删除按钮即可删除教室的相关信息</th></tr>
        <tr><th>校区</th><th>教学楼</th><th>教室号</th><th>星期</th><th>节数</th><th>使用情况</th><th>确认删除</th></tr>
           <%
           ...
           {
			int num=rs.getInt(7);
           out.println("<tr><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getInt(3)+"</td><td>"+rs.getString(4)+"</td>><td>"+rs.getString(5)+"</td><td>"+rs.getString(6)+"</td><td><a href='delclass.jsp?num="+num+"'>删除</a></td>></tr>");
        }
        rs.close();
        stmt.close();
        con.close();
